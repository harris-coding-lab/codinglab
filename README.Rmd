...
You can install the development version of codinglab from [GitHub](https://github.com/) with:
...
To run a tutorial in this package, install the codinglab package, then use the learnr function `run_tutorial` to launch the interactive tutorial in your browser:
...
Replace the first argument of `run_tutorial` with the appropriate tutorial name to run it.
