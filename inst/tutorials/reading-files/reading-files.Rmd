...
We've provided a clean dataset of student loan data for you for this assignment. We ran the following code on this [student loan Excel dataset](www/area_report_by_year.xlsx) (click to download to your computer) to get a clean version, which you can [download here](www/student_loan_debt.csv).
